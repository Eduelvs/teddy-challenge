  ...
  return (
    <div className="clientes-container">
      ...
      <div className="clientes-footer">
        <button className="criar-btn" onClick={() => setModalOpen(true)}>
          <b>Criar cliente</b>
        </button>
      ...
      />
      <SuccessPopup
        show={showSelectSuccess}
        message="Cliente selecionado com sucesso!"
        onClose={() => setShowSelectSuccess(false)}
      />
      <EditClienteModal
        ...
        cliente={
          clienteEdit
            ? {
                ...
                salary: clienteEdit.salary,
                companyValuation: clienteEdit.companyValuation,
              }
            : undefined
        }
        onSuccess={async () => {
